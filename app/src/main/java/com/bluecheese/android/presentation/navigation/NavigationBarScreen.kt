...
import com.bluecheese.android.ui.ScaleIn
import com.bluecheese.android.ui.SlideInFromBottom
...
fun NavigationBarScreen(model: Model<NavigationBarState, NavigationBarIntent>) {
    ...
    val onHideNavigationBar = { NavigationBarIntent.Hide.let(onIntent) }
    val onShowNavigationBar = { NavigationBarIntent.Show.let(onIntent) }
    ...
    val homeContent = @Composable {
        ...
        Column {
            HomeScreen(
                model = homeViewModel,
                onHideNavigationBar = onHideNavigationBar,
...
private fun NavigationBarScreen(
    ...
    Scaffold(
        bottomBar = {
            SlideInFromBottom(isVisible = state.isNavigationBarVisible) {
                NavigationBar {
        ...
        floatingActionButton = {
            ScaleIn(isVisible = state.isNavigationBarVisible) {
                Box {
                    FloatingActionButton(
                        onClick = {
